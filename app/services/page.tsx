          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 divide-x divide-border/60">
            {[
              ...
              <div key={stat.label} className="py-10 px-8 text-center">
                <p className="text-4xl font-bold text-primary mb-1 tracking-tight">
                  {stat.value}
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm text-white/50">
                ...
                <li><Link href="/services/visa-consultation" className="hover:text-white transition-colors">Visa Guidance</Link></li>
